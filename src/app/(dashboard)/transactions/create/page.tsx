...
export default async function CreateTransactionPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {!error && (categories.length === 0 || accounts.length === 0) ? <Alert title="Lengkapi pengaturan terlebih dahulu">Anda memerlukan setidaknya satu kategori aktif dan satu akun aktif sebelum mencatat transaksi.</Alert> : null}
